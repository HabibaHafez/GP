...
class BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: const <BottomNavigationBarItem>[
        BottomNavigationBarItem(
          icon: Icon(Icons.home_filled), // Updated icon for Courses
          label: 'Home',
        ),
        BottomNavigationBarItem(
          icon: Icon(Icons.chat_bubble), // Updated icon for Internships
          label: 'Chat',
        ),
        BottomNavigationBarItem(
          icon: Icon(Icons.person), // Updated icon for Home
          label: 'Profile',
        ),
      ],
    );
