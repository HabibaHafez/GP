...
// import 'package:techmate/ProfileScreen/area_of_interest.dart'; // Import AreaOfInterestScreen
...
//                   Divider(),
//                   ListTile(
//                     leading: Icon(Icons.interests, color: Colors.blue[800]), // Update the icon
//                     title: Text('Area of Interest'),
//                     trailing: Icon(Icons.arrow_forward_ios, color: Colors.blue[800]),
//                     onTap: () {
//                       Navigator.push(
//                         context,
//                         MaterialPageRoute(builder: (context) => AreaOfInterestScreen()), // Update the screen
//                       );
//                     },
//                   ),
//                   Divider(),
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Divider(),
                  ListTile(
                    leading: Icon(Icons.assignment_sharp, color: Colors.blue[800]),
                    title: Text('Bulid Your Resume!'),
                    trailing: Icon(Icons.arrow_forward_ios, color: Colors.blue[800]),
                    onTap: () {
                      Navigator.push(
                        context,
