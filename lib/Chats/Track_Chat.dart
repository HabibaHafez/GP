...
class _WritingMessageScreenState extends State<WritingMessageScreen> {
  final List<ChatMessage> _messages = [
    ChatMessage(
        isUser: false,
        text:
            "I'm excited to guide you through your learning journey. Let's get started!"),
    ChatMessage(isUser: true, text: 'Sure! When works for you?'),
    ChatMessage(isUser: false, text: 'Today 11:00'),
    ChatMessage(
        isUser: true, text: 'I have some questions about the assignment.'),
  ];
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                            color: Color.fromRGBO(21, 101, 192,
                                1)), // Set the desired border color
                      ),
                    ),
